...
docker build --build-arg CMAKE_VERSION=${CMAKE_VERSION} --build-arg CMAKE_BUILD=${CMAKE_BUILD} --build-arg QT_VERSION=${QT_VERSION} --build-arg CLANG_VERSION=${CLANG_VERSION} -t ${IMAGE_NAME} .
